...
<head>
<title>Ak Software Solutions</title>
<meta charset="utf-8">
...
<a href="#" class="unslate_co--site-logo">Ak Solutions<span>.</span></a>
</div>
...
<div class="cover-v1 jarallax" style="background-image: url('images/cover1.jpg');" id="home-section">
<div class="container">
<div class="row align-items-center">
<div class="col-md-7 mx-auto text-center">
<h1 class="heading gsap-reveal-hero">Ak Solutions</h1>
<h2 class="subheading gsap-reveal-hero">Aim to bring every business user under a single roof of this virtual world</h2>
</div>
</div>
</div>
...
<img src="images/pyt.png" class="lazyload  img-fluid" alt="Images" />
</a>
</div>
<div class="item illustration packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
<a href="images/node.png" class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Shoe Rebranding">
<div class="overlay">
<span class="wrap-icon icon-photo2"></span>
<div class="portfolio-item-content">
<h3>Node Js</h3>
<p>For api Development</p>
</div>
</div>
<img src="images/node.png" class="lazyload  img-fluid" alt="Images" />
</a>
</div>
<div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
...
<img src="images/htm.png" class="lazyload  img-fluid" alt="Images" />
</a>
</div>
<div class="item branding packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
<a href="images/mongo.png" class="portfolio-item item-portrait isotope-item gsap-reveal-img " data-fancybox="gallery" data-caption="Modern Building">
<div class="overlay">
<span class="wrap-icon icon-photo2"></span>
<div class="portfolio-item-content">
<h3>Data Base</h3>
...
<img src="images/mongo.png" class="lazyload  img-fluid" alt="Images" />
</a>
</div>
<div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
<div class="overlay">
...
<img src="images/host.jpg" class="lazyload  img-fluid" alt="Images" />
</a>
</div>
<div class="item web illustration col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
<a href="images/sql.png" class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Render Packaging">
<div class="overlay">
<span class="wrap-icon icon-photo2"></span>
<div class="portfolio-item-content">
...
<img src="images/sql.png" class="lazyload  img-fluid" alt="Images" />
</a>
</div>
</div>
</div>
...
<center><h1>Just Kidding Loll, but will surely make above clients happen for us</h1></center>
...
<p class="lead gsap-reveal">My main goal is to give accesbility for every business to have their own web site</p>
<p class="mb-4 gsap-reveal">with low cost and make them grow, as online is the future</p>
<p class="gsap-reveal">#$@%^*19*&95</a></p>
</div>
</div>
</div>
</div>
...
<h3>Web <br> Design</h3>
<p>Let's lit the internet like never before</p>
</div>
</div>
<div class="col-md-6 col-lg-4 mb-4">
...
<p>Let's lit the internet like never before, static and dymanic sites</p>
</div>
</div>
<!--<div class="col-md-6 col-lg-4 mb-4">
<div class="feature-v1" data-aos="fade-up" data-aos-delay="100">
...
<script>(function(w, d) { w.CollectId = "5e99816c2bf69958e24c5ff5"; var h = d.head || d.getElementsByTagName("head")[0]; var s = d.createElement("script"); s.setAttribute("type", "text/javascript"); s.async=true; s.setAttribute("src", "https://collectcdn.com/launcher.js"); h.appendChild(s); })(window, document);</script>
</div> 
</div>
</div>
...
<span class="number number-counter" data-number="-964">0</span>
<span class="append-text">%</span>
</span>
<span class="counter-label">Nodejs</span>
</div>
</div>
<div class="col-6 col-sm-6 mb-5 mb-lg-0 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
<div class="counter-v1 text-center">
<span class="number-wrap">
<span class="number number-counter" data-number="-564">0</span>
<span class="append-text">%</span>
</span>
...
<div class="counter-v1 text-center">
<span class="number-wrap">
<span class="number number-counter" data-number="-150">0</span>
<span class="append-text">%</span>
</span>
...
<div class="counter-v1 text-center">
<span class="number-wrap">
<span class="number number-counter" data-number="-364">0</span>
<span class="append-text">%</span>
</span>
...
<center><h3><span>Dont Believe Numbers always beleive in Effort & Out Put</span></center>
...
<a href="#" class="contact-info-val">b.akhil072@gmail.com</a>
</div>
<div class="gsap-reveal d-block">
<span class="d-block contact-info-label">Phone</span>
<a href="#" class="contact-info-val">8712996189,8328553987</a>
</div>
<div class="gsap-reveal d-block">
<span class="d-block contact-info-label">Address</span>
<address class="contact-info-val">Kakinada, East godavari</address>
</div>
</div>
</div>
</div>
...
<div class="col-md-7">
<div class="footer-site-logo"><a href="#">Ak Solutions<span>.</span></a></div>
...
<!-- Mirrored from preview.colorlib.com/theme/unfold/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Feb 2021 11:55:13 GMT -->
</html>